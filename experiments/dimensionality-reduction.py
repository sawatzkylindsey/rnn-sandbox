...
# Pretend these are the set of weights that we need dimensional reduce
a = np.array([0,1,0,1,0])
b = np.array([1,0,1,0,1])
c = np.array([1,1,1,1,1]) # a + b

# Reduce dimensionality proof of concept (ie: use t-SNE library)
# TODO
