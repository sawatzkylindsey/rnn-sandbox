...
echo -e "python generate-sequential-model.py -v ${NAME}-data ${NAME}-sequential --consecutive-decays 1"
...
echo -e "python generate-hidden-states.py -v ${NAME}-data ${NAME}-sequential ${NAME}-states --sample-rates .2 .5"
...
echo -e "python generate-reduction-buckets.py -v ${NAME}-states ${NAME}-buckets 10"
...
echo -e "python generate-semantic-model.py -v ${NAME}-data ${NAME}-states ${NAME}-encoding"
